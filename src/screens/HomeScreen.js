...
export default function HomeScreen() {
   ...
   * Contains all recipe categories with their images
   * In production, this would typically come from an API
   */
  ...
  /**
   * All Food Items Array (Complete Recipe Database)
   * Contains comprehensive recipe data with all details
   * Each item includes: category, id, name, image, description, etc.
   */
